...
def render_bounding_boxes(boxes, scores, classes, inputFileNames, outputFileNames=[],
    ...
    for iImage in range(0, nImages):
        ...
        """
        outputFileName = 'output_0004.jpg'
        image = inputFileName

        iBox = 0;
        box = boxes[iImage][iBox]
        dpi = 100
        s = image.shape;
        imageHeight = s[0];
        imageWidth = s[1]
        ...
        for iBox, box in enumerate(boxes[iImage]):
            ...
            return x, y, rightRel * imageWidth, bottomRel * imageWidth
            ...
            iLeft = x
            iBottom = y
            rect = patches.Rectangle((iLeft, iBottom), w, h, linewidth=linewidth, edgecolor='r', facecolor='none')
...
def load_and_run_detector(modelFile, imageFileNames,
    ...
    x_min, y_min, x_max, y_max = render_bounding_boxes(boxes=boxes, scores=scores, classes=classes,
                                                       inputFileNames=imageFileNames, outputFileNames=outputFileNames,
                                                       confidenceThreshold=confidenceThreshold)

    return detection_graph, x_min, y_min, x_max, y_max
...
def run_detector(image_path):
    ...
    if len(sys.argv[1:]) == 0:
        ...
        parser.exit()
    """
    #  --imageFile "Test_img/0004.jpg"
    args = parser.parse_args()
    args.imageDir = ""
    args.detectorFile = "megadetector_v2.pb"
    args.imageFile = image_path
    args.threshold = 0.85
    ...
    _, x_min, y_min, x_max, y_max = load_and_run_detector(modelFile=args.detectorFile, imageFileNames=imageFileNames,
                                                          confidenceThreshold=args.threshold)
    print(x_min, y_min, x_max, y_max)


if __name__ == '__main__':
    path = "/home/eslam/Masters/NN/IWild_project/YOLOv3_TensorFlow/data/my_data/training/5a0affac-23d2-11e8-a6a3-ec086b02610b.jpg"
    run_detector(path)
